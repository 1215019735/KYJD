        ...
        <div class="core">
            ...
            <ul class="public-nav">
                <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><li>
                        <a href="<?php echo U('News/index',array('id'=>$nav['id']));?>"><?php echo ($nav["name"]); ?></a>
            ...
            <div class="news-box public">
                <ul>
                    <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo U('News/content',array('id'=>$vo['id']));?>" class="clearfix">
                                <div class="news-titles">· <?php echo ($vo["title"]); ?></div>
                                <div class="news-times"><?php echo ($vo["times"]); ?></div>
                            </a>
                        </li>
                        <hr class="rule" /><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
