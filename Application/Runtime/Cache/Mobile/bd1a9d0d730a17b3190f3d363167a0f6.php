...
<body>
    ...
    <div class="show-page-banner">
        <div class="core">
            <div class="public-title hr">
                <span>酒店展示</span>
            </div>
            <ul class="show-page-nav">
                <?php if(is_array($showcate)): $i = 0; $__LIST__ = $showcate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><li>
                        <a href="<?php echo U('Show/index',array('id'=>$cate['id']));?>"><?php echo ($cate["name"]); ?></a>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="vr">
                    <a href="https://720yun.com/t/853jupmOzm2?scene_id=22576819">VR</a>
                </div>
            </ul>
            <div class="show-page-box public">
                <div class="show-page-main">
                    <ul class="show-main-page-nav">
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <a href="<?php echo U('Show/content',array('id'=>$vo['id']));?>">
                                    <img src="<?php echo ($vo["img"]); ?>" />
                                    <div class="show-page-title"><?php echo ($vo["name"]); ?></div>
                                </a>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
    ...
    <script>
        var navLength = $('.show-page-nav>li').length;
        var href = window.location.href.toLowerCase();
        for (let i = 0; i < navLength; i++) {
            var url = $('.show-page-nav>li').eq(i).children('a').attr('href').toLowerCase();
            if (href.lastIndexOf(url) > -1) {
                $('.show-page-nav>li').eq(i).addClass('hover').siblings().removeClass('hover');
            }
        }
    </script>
