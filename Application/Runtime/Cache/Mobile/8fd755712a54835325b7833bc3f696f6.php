...
<body>
    ...
    <div class="select-banner">
        <div class="core">
            ...
            <div class="select-page-box">
                <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="select-img">
                        <a href="<?php echo U('Select/content',array('id'=>$vo['id']));?>">
                            <img src="<?php echo ($vo["img"]); ?>" />
                        </a>
                    </div>
                    <div class="select-title">
                        <a href="<?php echo U('Select/content',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
                    </div>
                    <div class="select-page-preview"><?php echo ($vo["preview"]); ?></div><?php endforeach; endif; else: echo "" ;endif; ?>
