    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Category');?>" class="current"><span>服务设施-分类管理</span></a>
            </div>
            <h1>服务设施-分类管理中心</h1>
        </div>
        <hr />
                        ...
                        <form method="post" id="form">
                            <div class="widget-content">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<?php echo U('CateAddList',array('category'=>$vo['id']));?>" class="btn btn-mini btn-info">
