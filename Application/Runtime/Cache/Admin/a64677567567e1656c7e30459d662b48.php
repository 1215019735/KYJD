    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Index');?>" class="current"><span>订单-管理</span></a>
            </div>
            <h1>订单-管理中心</h1>
        </div>
        <hr />
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX">
                                                ...
                                                <td class="center fontCenter"><?php echo ($vo["tel"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["start"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["end"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["roomcount"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["roomtype"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["price"]); ?></td>
