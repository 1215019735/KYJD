    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Category');?>" class="current"><span>酒店展示-分类管理</span></a>
            </div>
            <h1>酒店展示-分类管理中心</h1>
        </div>
        <hr />
                        ...
                        <form method="post" id="form">
                            <div class="widget-content">
                                <div class="btn-group mb10">
                                    <a href="<?php echo U('CateAdd');?>" class="btn btn-danger">
                                        <i class="icon-plus"></i> 添加
                                    </a>
                                    <button id="delall" ajax-url="<?php echo U('CateDelete');?>" type="button" class="btn"
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                <td class="center">
                                                    <input type="checkbox" name="checkbox" value="<?php echo ($vo["id"]); ?>">
                                                </td>
                                                <td class="center"><?php echo ($vo["level"]); ?></td>
                                                <td class="center"><?php echo ($vo["str"]); echo ($vo["name"]); ?></td>
                                                <td class="center"><?php echo ($vo["orderid"]); ?></td>
                                                <td class="center">
                                                    <div class="btn-group">
                                                        <a href="<?php echo U('CateAddList',array('category'=>$vo['id']));?>"
                                                            class="btn btn-mini btn-info">
                                                            <i class="icon-plus"></i> 新增子分类
                                                        </a>
                                                        <a href="<?php echo U('CateEdit',array('id'=>$vo['id']));?>" class="btn btn-mini btn-info">
                                                            <i class="icon-edit"></i> 修改
                                                        </a>
                                                        <a href="javascript:void(0);" id="delete" ajax-url="<?php echo U('CateDelete');?>"
