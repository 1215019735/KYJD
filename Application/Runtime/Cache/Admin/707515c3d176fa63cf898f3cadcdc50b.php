    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Index');?>" class="current"><span>数据备份-管理</span></a>
            </div>
            <h1>数据备份-管理中心</h1>
        </div>
        <hr />
                        ...
                        <form id="form" method="post">
                            <div class="widget-content">
                                <div class="btn-group mb10">
                                    <button id="backups" ajax-url="<?php echo U('Backups');?>" type="button" class="btn btn-danger"
                                        onclick="common.confAction('#backups',{},'确定备份？')"><i class="icon-plus"></i> 备份</button>
                                    ...
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX">
                                                <td class="center fontCenter">
                                                    <input type="checkbox" name="checkbox" value="<?php echo ($vo["name"]); ?>">
                                                </td>
                                                <td class="center fontCenter"><?php echo ($vo["name"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["times"]); ?></td>
                                                <td class="center fontCenter">
                                                    <div class="btn-group">
                                                        <a href="javascript:void(0);" id="restore" ajax-url="<?php echo U('Restore');?>"
                                                            onclick="common.confAction('#restore',{id:'<?php echo ($vo["name"]); ?>'},'确定还原？')"
                                                            class="btn btn-mini btn-info">
                                                            <i class="icon-edit"></i> 还原
                                                        </a>
                                                        <a href="javascript:void(0);" id="delete" ajax-url="<?php echo U('Delete');?>"
                                                            onclick="common.confAction('#delete',{id:'<?php echo ($vo["name"]); ?>'},'确定删除？')"
                                                            class="btn btn-mini btn-info">
