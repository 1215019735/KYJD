    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Index');?>" class="current"><span>管理员-管理</span></a>
            </div>
            <h1>管理员-管理中心</h1>
        </div>
        <hr />
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data["list"])): foreach($data["list"] as $key=>$vo): ?><tr class="odd gradeX">
                                                ...
                                                <td class="center fontCenter"><?php echo ($vo["loginname"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["truename"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["groupname"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["loginnum"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["lasttime"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["lastarea"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["lastip"]); ?></td>
                                                <td class="center fontCenter">
                                                    <div class="btn-group">
                                                        <a href="<?php echo U('Index/EditPwd',array('id'=>$vo['id']));?>" class="btn btn-mini btn-info">
