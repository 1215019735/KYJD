    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Index');?>" class="current"><span>系统信息</span></a>
            </div>
            <h1>系统信息</h1>
        </div>
        <hr />
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td class="center half">请求Host</td>
                                        <td class="center half"><?php echo ($_SERVER['HTTP_HOST']); ?></td>
                                    </tr>
                                    <tr class="odd gradeX">
                                        <td class="center half">服务器系统</td>
                                        <td class="center half"><?php echo ($info["os"]); ?>(<?php echo ($info["osBit"]); ?>)</td>
                                    </tr>
                                    <tr class="odd gradeX">
                                        <td class="center half">PHP版本</td>
                                        <td class="center half"><?php echo ($info["php"]); ?></td>
                                    </tr>
                                    <tr class="odd gradeX">
                                        <td class="center half">数据库类型</td>
                                        <td class="center half"><?php echo ($info["dataType"]); ?></td>
                                    </tr>
                                    <tr class="odd gradeX">
                                        <td class="center half">数据库大小</td>
                                        <td class="center half"><?php echo ($info["dataSize"]); ?> KB</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
