    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('Index');?>" class="current"><span>地图坐标-管理</span></a>
            </div>
            <h1>地图坐标-管理中心</h1>
        </div>
        <hr />
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX">
                                                ...
                                                <td class="center fontCenter"><?php echo ($vo["eastcoor"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["northcoor"]); ?></td>
                                                <td class="center fontCenter"><?php echo ($vo["coorname"]); ?></td>
                                                <td class="center fontCenter">
                                                    <div class="btn-group">
