    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo U('In');?>" class="current"><span>内部展示-管理</span></a>
            </div>
            <h1>内部展示-管理中心</h1>
        </div>
        <hr />
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <select name="category">
                                    ...
                                    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i; if($cate["id"] == $category): ?><option value="<?php echo ($cate["id"]); ?>" selected><?php echo ($cate["str"]); echo ($cate["name"]); ?></option>
                                            <?php else: ?>
                                            <option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["str"]); echo ($cate["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <input name="key" type="text" value="" placeholder="输入文章名称关键词">
                                <br />
                        ...
                        <form method="post" id="form">
                            <div class="widget-content">
                                <div class="btn-group mb10">
                                    <a href="<?php echo U('InAdd');?>" class="btn btn-danger">
                                        <i class="icon-plus"></i> 添加
                                    </a>
                                    <button id="delall" ajax-url="<?php echo U('InDelete');?>" type="button" class="btn"
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data["list"])): foreach($data["list"] as $key=>$vo): ?><tr class="odd gradeX">
                                                <td class="center fontCenter">
                                                    <input type="checkbox" name="checkbox" value="<?php echo ($vo["id"]); ?>">
                                                </td>
                                                <td class="center fontCenter"><?php echo ($vo["name"]); ?></td>
                                                <td class="center fontCenter">
                                                    <img src="<?php echo ($vo["img"]); ?>" />
                                                </td>
                                                <td class="center fontCenter"><?php echo ($vo["orderid"]); ?></td>
                                                <td class="center fontCenter">
                                                    <div class="btn-group">
                                                        <a href="<?php echo U('InEdit',array('id'=>$vo['id']));?>" class="btn btn-mini btn-info">
                                                            <i class="icon-edit"></i> 修改
                                                        </a>
                                                        <a href="javascript:void(0);" id="delete" ajax-url="<?php echo U('InDelete');?>"
