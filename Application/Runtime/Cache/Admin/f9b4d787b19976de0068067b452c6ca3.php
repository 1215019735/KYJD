    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="javascript:void(0)" title="Go to Home" class="tip-bottom"><i class="icon-home"></i><span>首页</span></a>
                <a href="<?php echo U('Index');?>" class="tip-bottom"><span>酒店精选-管理</span></a>
                <a href="<?php echo U('Add');?>" class="current">修改-酒店精选</a></div>
            <h1>酒店精选-修改页面</h1>
        </div>
        <hr />
                        ...
                        <div class="widget-content nopadding">
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="url" name="img" value="<?php echo ($data["img"]); ?>" required />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" style="width: 300px;" name="title" value="<?php echo ($data["title"]); ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="Jx_Edit" name="content" style="width:91.48936170212765%;height:300px;">
                                            <?php echo ($data["content"]); ?>
                                        </textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">标题-英文版 :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" style="width: 300px;" name="etitle" value="<?php echo ($data["etitle"]); ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="Jx_EEdit" name="econtent" style="width:91.48936170212765%;height:300px;">
    ...
    <script>
        $(document).ready(function () {
            ...
            KindEditor.ready(function (K) {
                editor = K.create('textarea[id="Jx_Edit"]', {
            ...
            var Eeditor;
            KindEditor.ready(function (K) {
                Eeditor = K.create('textarea[id="Jx_EEdit"]', {
                    allowPreviewEmoticons: false,
                    allowImageUpload: true,
                    allowFileManager: true,
                    uploadJson: '/Public/Static/kindeditor/php/upload_json.php',
